...
hl.device({
    name = "elan9008:00-04f3:2f29",
    output = "eDP-1"
})
hl.device ({
    name = "elan9009:00-04f3:2f2a",
    output = "DP-1"
})
hl.device({
...
hl.device ({
    name = "elan9009:00-04f3:2f2a-stylus",
    output = "DP-1"
})
...
-- end)
hl.exec_cmd("waybar -c /home/au512/.config/waybar/CnM/config -s /home/au512/.config/waybar/CnM/style.css  & kdeconnectd")
hl.exec_cmd("dunst")
hl.exec_cmd("hyprsunset")
hl.exec_cmd("hypridle")
hl.exec_cmd("hyprpaper")
hl.exec_cmd("~/Scripts/media-player-inhibit-sleep.py")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(996912ee)", "rgba(debb12ee)"}, angle = 45 },
...
-- Sign Out
hl.bind(mainMod .. " + XF86PowerOff", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
for i = 1, 10 do
    ...
    -- Fullscreen using scroll wheel or keyboard
    hl.bind(mainMod .. " + mouse_down", hl.dsp.window.fullscreen({ fullscreen,set }))
    hl.bind(mainMod .. " + mouse_up", hl.dsp.window.fullscreen({ fullscreen,unset }))
    hl.bind(mainMod .. " + X", hl.dsp.window.fullscreen({ fullscreen, toggle }))
    ...
    hl.bind(mainMod .. " + XF86AudioMute", hl.dsp.exec_cmd("playerctl play-pause"),     { locked = true })
